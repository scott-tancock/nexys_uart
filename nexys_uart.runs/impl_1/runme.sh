...
HD_PWD='C:/Users/Scott/Dropbox/Xilinx/Projects/nexys_uart/nexys_uart.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log NexysVideo_A.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source NexysVideo_A.tcl -notrace
